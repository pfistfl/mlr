...
mlr$measure.properties = c("oneclass", "classif", "classif.multi", "multilabel", "regr", "surv",
  "cluster", "costsens", "req.pred", "req.truth", "req.task", "req.feats", "req.model", "req.prob",
  "fdaregr", "fdaclassif", "fdaoneclass")
